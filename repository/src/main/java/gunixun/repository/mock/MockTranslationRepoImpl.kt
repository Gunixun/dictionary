package gunixun.repository.mock
...
class MockTranslationRepoImpl : TranslationRepo {
    ...
    private val data: List<DataModel> = listOf(
        DataModel(
            id = 480469417, text = "help", meanings = listOf(
                Meaning(
                    180270,
                    "помогать",
                    "кому-либо c чем-либо; делать что-либо",
                    "//cdn-user77752.skyeng.ru/resized-images/96x72/jpeg/60/8d5a91716bd730c3d4a8bdeb7238a3b8.jpeg",
                    "//cdn-user77752.skyeng.ru/resized-images/640x480/jpeg/60/8d5a91716bd730c3d4a8bdeb7238a3b8.jpeg",
                    ""
                ),
        ...
        DataModel(
            id = 480469417, text = "test", meanings = listOf(
        ...
        DataModel(
            id = 480469417, text = "post", meanings = listOf(
